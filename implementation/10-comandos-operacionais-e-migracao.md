...
- S10.09 e S10.10 foram fechadas por `docs/compatibility/s10-report.{json,md}`: execução de
  `2026-07-20T11:34:50.451Z`, 91/91 checks, zero regressions e zero surface regressions, com
  `ralph 0.2.0` e `ralph-next 0.1.0-beta.2` reais, source `cc02175e...` e binários imutáveis, coexistência,
