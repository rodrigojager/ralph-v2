...
- S10.09 e S10.10 foram fechadas por `docs/compatibility/s10-report.{json,md}`: execução de
  `2026-07-19T23:05:54.068Z`, 91/91 checks, zero regressions e zero surface regressions, com
  `ralph 0.2.0` e `ralph-next 0.1.0-dev.1` reais, source/binários imutáveis, coexistência,
